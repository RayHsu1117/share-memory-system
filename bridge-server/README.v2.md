# Bridge Memory MCP Server (README v2)

> 這是 `README.md` 的更新版草稿,依照 `../bridge_multi_deploy_addendum.md` 的
> 「`README.md` 實際落差清單」逐條修正,目標是讓別人也能照著這份文件獨立部署
> 一份完全屬於自己的橋接記憶系統。原本的 `README.md` 未變動。
